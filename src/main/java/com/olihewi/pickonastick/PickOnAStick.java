package com.olihewi.pickonastick;

import com.olihewi.pickonastick.util.EventSubscriber;
...
@Mod("pickonastick")
public class PickOnAStick
{
  private static final Logger LOGGER = LogManager.getLogger();
  public static final String MOD_ID = "pickonastick";
