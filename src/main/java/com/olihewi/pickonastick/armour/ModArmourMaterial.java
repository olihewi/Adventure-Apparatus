package com.olihewi.pickonastick.armour;
...
{
  PHANTOM_WINDBREAKER_MATERIAL(PickOnAStick.MOD_ID + ":phantom_windbreakers", 325,
      new int[] { 1, 1, 1, 1}, 18, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, Ingredient.of(Items.PHANTOM_MEMBRANE)),
  SHUTTLE_SHOES_MATERIAL(PickOnAStick.MOD_ID + ":shuttle_shoes", 250,
